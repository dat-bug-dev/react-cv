            ...
            <div className="row">
              ...
              <div className="col-lg-9">
                <div className="content">
                  ...
                  <div id="about" className="content_wrap d-none tab-content">
                    <div className="page-title">
                      <h2>Một vài điều về bản thân</h2>
                    </div>
                    ...
                    <div className="content-dev">
                      <h2 className="title">I'm Developer</h2>
                  ...
                  <div id="portfolio" className="content-portfolio tab-content">
                    <div className="page-title">
